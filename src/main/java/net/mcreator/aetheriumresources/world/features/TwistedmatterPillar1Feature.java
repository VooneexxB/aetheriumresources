...
public class TwistedmatterPillar1Feature extends Feature<NoneFeatureConfiguration> {
	public static TwistedmatterPillar1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TwistedmatterPillar1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("aetheriumresources:twistedmatter_pillar_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("aetheriumresources:twistedmatter_pillar_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public TwistedmatterPillar1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("aetheriumresources", "twistedmatter_pillars"));
		if (template == null)
			return false;
