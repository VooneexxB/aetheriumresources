...
public class InvertedErrorPathFeature extends Feature<NoneFeatureConfiguration> {
	public static InvertedErrorPathFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new InvertedErrorPathFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("aetheriumresources:inverted_error_path", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("aetheriumresources:inverted_error_path", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public InvertedErrorPathFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("aetheriumresources", "inverted_error_path"));
		if (template == null)
			return false;
