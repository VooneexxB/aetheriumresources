...
public class TwistedmatterRuins1Feature extends Feature<NoneFeatureConfiguration> {
	public static TwistedmatterRuins1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TwistedmatterRuins1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("aetheriumresources:twistedmatter_ruins_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("aetheriumresources:twistedmatter_ruins_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public TwistedmatterRuins1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("aetheriumresources", "twistedmatter_ruins1"));
		if (template == null)
			return false;
