...
public class AmethystPurifierBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(5, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public AmethystPurifierBlockEntity(BlockPos position, BlockState state) {
		super(AetheriumresourcesModBlockEntities.AMETHYST_PURIFIER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("amethyst_purifier");
	}
