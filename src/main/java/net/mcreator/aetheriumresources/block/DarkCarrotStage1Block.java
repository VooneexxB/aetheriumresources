...
public class DarkCarrotStage1Block extends Block
		implements

			EntityBlock {

	public DarkCarrotStage1Block() {
	...
	public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
		return new DarkCarrotStage1BlockEntity(pos, state);
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(AetheriumresourcesModBlocks.DARK_CARROT_STAGE_1.get(), renderType -> renderType == RenderType.cutout());
	}
