...
public class AetheriumresourcesModItems {
	...
	public static final RegistryObject<Item> DARK_MATTER_FOREST_LEAVES = block(AetheriumresourcesModBlocks.DARK_MATTER_FOREST_LEAVES,
			AetheriumresourcesModTabs.TAB_AETHERIUM_TAB);
	public static final RegistryObject<Item> DARK_MATTER_FOREST_STAIRS = block(AetheriumresourcesModBlocks.DARK_MATTER_FOREST_STAIRS,
			AetheriumresourcesModTabs.TAB_AETHERIUM_TAB);
	...
	public static final RegistryObject<Item> DARK_MATTER_GEM = REGISTRY.register("dark_matter_gem", () -> new DarkMatterGemItem());
	public static final RegistryObject<Item> DARK_MATTER_GEM_BLOCK = block(AetheriumresourcesModBlocks.DARK_MATTER_GEM_BLOCK,
			AetheriumresourcesModTabs.TAB_AETHERIUM_TAB);
