...
import net.mcreator.aetheriumresources.world.biome.TwistedForestBiome;
...
public class AetheriumresourcesModBiomes {
	...
	public static final RegistryObject<Biome> TWISTED_FOREST = REGISTRY.register("twisted_forest", () -> TwistedForestBiome.createBiome());
}
