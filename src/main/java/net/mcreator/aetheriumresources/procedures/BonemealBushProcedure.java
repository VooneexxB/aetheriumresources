...
public class BonemealBushProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
			...
			activeStage = AetheriumresourcesModBlocks.TWISTED_BUSH_STAGE_0.get().defaultBlockState();
			nextStage1 = AetheriumresourcesModBlocks.TWISTED_BUSH_STAGE_1.get().defaultBlockState();
			nextStage2 = AetheriumresourcesModBlocks.TWISTED_BUSH_STAGE_2.get().defaultBlockState();
			nextStage3 = AetheriumresourcesModBlocks.TWISTED_BUSH_STAGE_3.get().defaultBlockState();
			random = Math.random();
