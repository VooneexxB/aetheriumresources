...
public class Bonemealstage0Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
			...
			activeStage = AetheriumresourcesModBlocks.DARK_CARROT_STAGE_0.get().defaultBlockState();
			nextStage1 = AetheriumresourcesModBlocks.DARK_CARROT_STAGE_1.get().defaultBlockState();
			nextStage2 = AetheriumresourcesModBlocks.DARK_CARROT_STAGE_2.get().defaultBlockState();
			nextStage3 = AetheriumresourcesModBlocks.DARK_CARROT_STAGE_3.get().defaultBlockState();
			random = Math.random();
