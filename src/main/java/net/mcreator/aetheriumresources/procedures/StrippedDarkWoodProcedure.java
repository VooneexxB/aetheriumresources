...
public class StrippedDarkWoodProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == AetheriumresourcesModBlocks.DARK_MATTER_FOREST_WOOD.get()) {
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof AxeItem) {
					...
					_entity.swing(InteractionHand.MAIN_HAND, true);
				{
					...
					BlockState _bs = AetheriumresourcesModBlocks.STRIPPED_DARK_MATTER_FOREST_WOOD.get().defaultBlockState();
