...
public class BloodySkyItem extends RecordItem {
	public BloodySkyItem() {
		super(0, AetheriumresourcesModSounds.REGISTRY.get(new ResourceLocation("aetheriumresources:death")),
